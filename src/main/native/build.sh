...
# **********************************************************************
# ORGANIZATION  :  Pi4J
# PROJECT       :  Pi4J :: JNI Native Binding Library for ws281xled
# FILENAME      :  build.sh
#
...
echo "**********************************************************************"
echo "*                                                                    *"
echo "*            Pi4J ws281xled LIBRARY NATIVE BUILD <STARTED>              *"
echo "*                                                                    *"
echo "**********************************************************************"
echo
...
echo "======================================"
echo " Pi4J ws281xled LIBRARY NATIVE ARTIFACTS "
echo "======================================"
tree -R lib
...
echo "**********************************************************************"
echo "*                                                                    *"
echo "*           Pi4J ws281xled LIBRARY NATIVE BUILD <FINISHED>              *"
echo "*                                                                    *"
echo "**********************************************************************"
echo